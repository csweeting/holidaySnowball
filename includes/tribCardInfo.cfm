...
<!-- Acknowledgement card form -->
        <section class="js_bcchf_ack_card_container">
            <form class="bcchf_step js_bcchf_ack_card" name="js_bcchf_ack_card" id="js_bcchf_ack_card" action="" method="post">
                ...
                <h3>Fill out information below to send your acknowledgement card.</h3>
            ...
            <section class="bcchf_personalized_msg">
                <p class="bcchf_titles">Your Personalized Message:</p>
                <div class="bcchf_input_container bcchf_text_container js_bcchf_input_container">
                    <label>Write your message or letter*:</label>
